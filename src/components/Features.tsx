            ...
            <div className="grid gap-8">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 group">
                    ...
                    <p className="text-white/70 mb-6">
                        I am knowledgeable about cutting-edge technology in addition to my principal software development skills. Together, we will create software that satisfies the requirements for availability, reliability, maintainability, security, and integrity.
                    </p>
